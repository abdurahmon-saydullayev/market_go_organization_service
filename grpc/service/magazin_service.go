...
// func (i *MagazinService) GetByID(ctx context.Context, req *organization_service.FilialPK) (resp *organization_service.Filial, err error) {
...
// func (i *MagazinService) GetList(ctx context.Context, req *organization_service.GetListFilialRequest) (resp *organization_service.GetListFilialResponse, err error) {
...
// func (i *MagazinService) Update(ctx context.Context, req *organization_service.UpdateFilial) (resp *organization_service.Filial, err error) {
...
// func (i *MagazinService) UpdatePatch(ctx context.Context, req *organization_service.UpdatePatchFilial) (resp *organization_service.Filial, err error) {
